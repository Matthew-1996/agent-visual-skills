...
1. 阅读 `${AGENT_VISUAL_HOME:-$HOME/agent-visual-skills}/codex/skills/web-visual/references/patterns.md`，选择一个主阅读模式；先写结论和决策问题，再安排证据。
...
6. 以 1440×1100 和 390×844 分别运行 `"${AGENT_VISUAL_HOME:-$HOME/agent-visual-skills}/tools/bin/render-diagram" html`；再实际触发关键交互，检查状态变化、控制台与页面错误、横向溢出、焦点样式、截断和可读性。
