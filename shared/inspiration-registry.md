...
## Cathryn Lavery — `cathrynlavery/diagram-design` v2.6
...
Register a candidate source here before it becomes a profile rule. Record its
license, proposed adaptation, and rejected rules; obtain approval for material
changes; then publish a new version such as `editorial-v1.1` and revise one
golden example. Do not install an external Skill as a competing visual router.
